...
A **key question** still open is whether to include areas with very small population.


| Variable   code | Variable description                                                                                                                                                      | Normalisation code | Normalisation description                                                                                                                                        |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| P1              | Popolazione residente - totale                                                                                                                                            |                    | Area (Km2)                                                                                                                                                       |
| P2              | Popolazione residente - maschi                                                                                                                                            | P1                 | Popolazione residente - totale                                                                                                                                   |
| P3              | Popolazione residente - femmine                                                                                                                                           | P1                 | Popolazione residente - totale                                                                                                                                   |
...
| P47             | Popolazione residente con   laurea vecchio e nuovo ordinamento + diplomi universitari + diplomi terziari   di tipo non universitario vecchio e nuovo ordinamento          | P1                 | Popolazione residente - totale                                                                                                                                   |
| P48             | Popolazione residente con   diploma di scuola secondaria superiore (maturità + qualifica)                                                                                 | P1                 | Popolazione residente - totale                                                                                                                                   |
| P49             | Popolazione residente con media   inferiore                                                                                                                               | P1                 | Popolazione residente - totale                                                                                                                                   |
| P50             | Popolazione residente con   licenza elementare                                                                                                                            | P1                 | Popolazione residente - totale                                                                                                                                   |
| P51             | Popolazione residente -   alfabeti                                                                                                                                        | P1                 | Popolazione residente - totale                                                                                                                                   |
| P52             | Popolazione residente -   analfabeti                                                                                                                                      | P1                 | Popolazione residente - totale                                                                                                                                   |
...
| P60             | Popolazione residente - totale   di 15 anni e più appartenente alle forze di lavoro totale                                                                                | P1                 | Popolazione residente - totale                                                                                                                                   |
| P61             | Popolazione residente - totale   di 15 anni e più occupata (FL)                                                                                                           | P1                 | Popolazione residente - totale                                                                                                                                   |
| P62             | Popolazione residente - totale   di 15 anni e più disoccupata in cerca nuova occupazione                                                                                  | P1                 | Popolazione residente - totale                                                                                                                                   |
...
| P128            | Popolazione residente - totale   di 15 anni e più non appartenente alle forze di lavoro (NFL)                                                                             | P1                 | Popolazione residente - totale                                                                                                                                   |
...
| P130            | Popolazione residente - totale   di 15 anni e più casalinghi/e                                                                                                            | P1                 | Popolazione residente - totale                                                                                                                                   |
| P131            | Popolazione residente - totale   di 15 anni e più studenti                                                                                                                | P1                 | Popolazione residente - totale                                                                                                                                   |
...
| P135            | Popolazione residente - totale   di 15 anni e più in altra condizione                                                                                                     | P1                 | Popolazione residente - totale                                                                                                                                   |
...
| A46             | Famiglie in alloggi in affitto                                                                                                                                            | PF1                | Famiglie residenti - totale                                                                                                                                      |
| A47             | Famiglie in alloggi di   proprietà                                                                                                                                        | PF1                | Famiglie residenti - totale                                                                                                                                      |
| A48             | Famiglie che occupano   l’alloggio ad altro titolo                                                                                                                        | PF1                | Famiglie residenti - totale                                                                                                                                      |
...
| E5              | Edifici ad uso residenziale in   muratura portante                                                                                                                        | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E6              | Edifici ad uso residenziale in   calcestruzzo armato                                                                                                                      | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E7              | Edifici ad uso residenziale in   altro materiale (acciaio, legno, ecc.)                                                                                                   | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E8              | Edifici ad uso residenziale   costruiti prima del 1919                                                                                                                    | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E9              | Edifici ad uso residenziale   costruiti dal 1919 al 1945                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E10             | Edifici ad uso residenziale   costruiti dal 1946 al 1960                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E11             | Edifici ad uso residenziale   costruiti dal 1961 al 1970                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E12             | Edifici ad uso residenziale   costruiti dal 1971 al 1980                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E13             | Edifici ad uso residenziale   costruiti dal 1981 al 1990                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E14             | Edifici ad uso residenziale   costruiti dal 1991 al 2000                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E15             | Edifici ad uso residenziale   costruiti dal 2001 al 2005                                                                                                                  | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E16             | Edifici ad uso residenziale   costruiti dopo il 2005                                                                                                                      | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E17             | Edifici ad uso residenziale con   un piano                                                                                                                                | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E18             | Edifici ad uso residenziale con   2 piani                                                                                                                                 | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E19             | Edifici ad uso residenziale con   3 piani                                                                                                                                 | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E20             | Edifici ad uso residenziale con   4 piani o più                                                                                                                           | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E21             | Edifici ad uso residenziale con   un interno                                                                                                                              | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E22             | Edifici ad uso residenziale con   2 interni                                                                                                                               | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E23             | Edifici ad uso residenziale da   3 a 4 interni                                                                                                                            | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E24             | Edifici ad uso residenziale da   5 a 8 interni                                                                                                                            | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E25             | Edifici ad uso residenziale da   9 a 15 interni                                                                                                                           | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E26             | Edifici ad uso residenziale con   16 interni o più                                                                                                                        | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E27             | Totale interni in edifici ad   uso residenziale                                                                                                                           | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E28             | Edifici ad uso residenziale con   stato di conservazione ottimo                                                                                                           | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E29             | Edifici ad uso residenziale con   stato di conservazione buono                                                                                                            | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E30             | Edifici ad uso residenziale con   stato di conservazione mediocre                                                                                                         | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
| E31             | Edifici ad uso residenziale con   stato di conservazione pessimo                                                                                                          | E1                 | Edifici e complessi di edifici   - totale                                                                                                                        |
...
As such, they will be discarded for the time being. The 10-resident threshold is very arbitrary and should be discussed.

```{r}
census_data_not_small <-
  census_data %>% 
  filter(P1 > 0)
```
...
census_data_no_na %>% 
  ...
  filter(value == 0) %>% 
  count(variable) %>% 
  mutate(perc = (n / nrow(census_data_not_small))*100) %>% 
  kable()
```
...
- PF7 and PF8 will be aggregated, and **PF9** will be removed
...
census_data_norm <-
  ...
  mutate(P128 = if_else(P1 == 0, 0, P128 / P1)) %>% 
  mutate(P130 = if_else(P1 == 0, 0, P130 / P1)) %>% 
  mutate(P131 = if_else(P1 == 0, 0, P131 / P1)) %>% 
  mutate(P135 = if_else(P1 == 0, 0, P135 / P1)) %>% 
  mutate(across(
    P137:P139, 
    function(x){if_else(P1 == 0, 0, x / P1)}
  )) %>% 
...
census_data_norm %>%
  select(
    ...
    A44_norm, P52_norm, P6_norm, 
    E27_norm, P8_norm, P46_norm
  ) %>% 
  pivot_longer(everything(), names_to = "variable", values_to = "value") %>% 
  ggplot(aes(x = value)) +
  geom_histogram() +
...
```{r}
census_data_norm_unskewed %>% 
  select(P1_norm_log10:E30_E31_norm_log10) %>% 
  summarise(across(P1_norm_log10:E30_E31_norm_log10, skewness)) %>% 
  pivot_longer(P1_norm_log10:E30_E31_norm_log10, names_to = "variable", values_to = "skewness") %>% 
  slice_max(order_by = skewness, n = 10)
...
census_data_norm_unskewed_std <-
  ...
  mutate(
    across(
      P1_norm_log10:E30_E31_norm_log10,
...
```{r}
census_data_norm_unskewed_std %>% 
  write_csv("../storage/dati-cpa_2011_all-trans-v0_0_3.csv")
```
