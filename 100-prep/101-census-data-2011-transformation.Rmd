...
[After further investigation and discussion](https://github.com/sdesabbata/2011-IEAC/issues/1), it seems that those areas are actually mostly industrial areas, which might be of interest as a cluster on its own right. As such all areas will be retained for classification but removed from outputs.
