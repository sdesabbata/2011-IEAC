...
census_data_kmeans_k20_RData_file <-
  "../storage/ieac_k20_kmeans_object-v0_0_4_18.RData"
...
```{r}
census_data_ieac_k20 %>% 
  write_csv("../storage/ieac_k20-with-vars-v0_0_4_18.csv") 

census_data_ieac_k20 %>% 
  select(CODREG:CODASC, ieac_k20, ieac_k20h) %>%
  write_csv("../storage/ieac_k20-no-vars-v0_0_4_18.csv") 
```
...
census_data_ieac_k20_geo %>% 
  saveRDS("../storage/ieac_k20-with-vars-v0_0_4_18.rds")

census_data_ieac_k20_geo %>% 
  write_sf("../storage/ieac_k20-with-vars-v0_0_4_18.geojson")

dir.create("../storage/ieac_k20-with-vars-v0_0_4_18")
census_data_ieac_k20_geo %>% 
  write_sf("../storage/ieac_k20-with-vars-v0_0_4_18/ieac_k20-with-vars-v0_0_4_18.shp")
```
